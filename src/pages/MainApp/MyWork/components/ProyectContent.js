        ...
        <Fragment>
            <Grid container spacing={6}>
                <Grid item xs={12} md={9}>
                    ...
                    { !info.sihoFlag? 
                        ...
                        :
                            <Fragment>
                                <Box sx={{mt:6}}>
                                    <Typography variant='subtitle1' className='fade fade2' >{info.info[0][0].subtitle}</Typography>
                                    <Typography variant='body1' className='fade fade3' sx={{mt:2}}>{info.info[0][0].body}</Typography>
                                ...
                                <Box sx={{mb:8}}>
                                    <Typography variant='subtitle1' className='fade fade2' >{info.info[0][1].subtitle}</Typography>
                                    <Typography variant='body1' className='fade fade3' sx={{mt:2,mb:6}}>{info.info[0][1].body}</Typography>
                                    ...
                                    <Typography variant='body1' className='fade fade3' sx={{mt:4}}>{info.info[0][1].body2}</Typography>
                                </Box>
                                {
                ...
                <Grid item xs={12} md={3}>
                    <Box sx={{position:'sticky',top:'90px', display:{xs:'none',sm:'block'}}}>
                        <MoreWorkOptions />
                    </Box>
                </Grid>
            </Grid>
